...
class OT {
    ...
    public void executeChooserOTs_EG(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeChooserOTs_EG: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
    ...
    public void executeSenderOTs_EG(Vector v, ObjectOutputStream oos,
	    ...
	    pub_key[1] =  MyUtil.EG_deduce(pub_key[0]);
            ...
            //logger.debug("executeSenderOTs_EG: OT no. " + i + " sending: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
    }
    ...
    public void executeChooserOTs_EGBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeChooserOTs_EGBatch: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
            ottask.setTransValue(valrec);
        }
    }
    ...
    public void executeSenderOTs_EGBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeSenderOTs_EGBatch: OT no. " + i + " preparing: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
    ...
    public void executeChooserOTs_EGNP(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeChooserOTs_EGNP: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
            ottask.setTransValue(valrec);
        }
    }
    ...
    public void executeSenderOTs_EGNP(Vector v, ObjectOutputStream oos,
	    ...
	    pub_key[1] = MyUtil.EG_deduce(pub_key[0]);
            ...
            MyUtil.sendOTMESS(oos, otmess_out); // Send EG encryptions to chooser
            //logger.debug("executeSenderOTs_EGNP: OT no. " + i + " sending: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
    }
    ...
    public void executeChooserOTs_EGNPBatch(Vector v, ObjectOutputStream oos,
	    ...
	    //logger.debug("executeChooserOTs_EGNPBatch: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
	    ottask.setTransValue(valrec);
        }
    }
    ...
    public void executeSenderOTs_EGNPBatch(Vector v, ObjectOutputStream oos,
	    ...
	    //logger.debug("executeSenderOTs_EGNPBatch: OT no. " + i + " preparing: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
    ...
    public void executeChooserOTs_EGOcomBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeChooserOTs_EGOcomBatch: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
            ottask.setTransValue(valrec);
        }
    }
    ...
    public void executeSenderOTs_EGOcomBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeSenderOTs_EGOcomBatch: OT no. " + i + " preparing: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
    ...
    public void executeChooserOTs_EGNPOcomBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            byte[] valrec = x[i].toByteArray(); // Dummy operation
            //logger.debug("executeChooserOTs_EGNPOcomBatch: OT no. " + i + " received: " + MyUtil.toHexString(valrec));
            ottask.setTransValue(valrec);
        }
    }
    ...
    public void executeSenderOTs_EGNPOcomBatch(Vector v, ObjectOutputStream oos,
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            //logger.debug("executeSenderOTs_EGNPOcomBatch: OT no. " + i + " preparing: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
        }
	...
	for (int i = 0; i < v.size(); i++) {
	    ...
	    //Done!
	    //logger.debug("executeChooserOTs_BOT: OT no. " + i + " received: " + MyUtil.toHexString(valrec.toByteArray() ));
	...
	for (int i = 0; i < v.size(); i++) {
	    ...
	    MyUtil.sendOTMESS(oos, otmess_out); // Send everything to chooser	
	    //logger.debug("executeSenderOTs_BOT: OT no. " + i + " sending: " + MyUtil.toHexString(mess0) + " or " + MyUtil.toHexString(mess1));
	}
    }
	...
	for (int i = 0; i < v.size(); i++) {
	    ...
	    //logger.debug("executeSenderOTs_BOT: OT no. " + i + " sending: " + MyUtil.toHexString(mess[2*i].toByteArray()) + " or " + MyUtil.toHexString(mess[2*i+1].toByteArray()));
	}
	//Sending the y and the encrypted stuff.
	otmess_out = new OTMESS(yms);
	MyUtil.sendOTMESS(oos, otmess_out); // Send everything to chooser
