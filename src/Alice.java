		...
		*/
        ...
        for (i = 0; i < num_iterations; i++) {
            ...
            try {
                ...
                //logger.error("Alice: cannot open/close " + fmt_filename + " - " + e.getMessage());
            ...
            try {
                ...
                //logger.error("Alice: cannot open/close " + circuit_filename + " - " + e.getMessage());
                System.exit(1);
            } catch (Exception e) {
                //logger.error("Alice: exception - " + e.getMessage());
                System.exit(1);
			...
			System.out.println("Receive encrypted circuit");
			...
			System.out.println("Receive encrypted circuit secrets");
            for (j = 0; j < num_of_circuits ; j++) {
               if (j != cc_num) {
                  ...
                  //[DEBUG]
				String encoded = Base32.encode(SecPayload);
				//System.out.println("SecPayload: "+ encoded);	
				System.out.println("SecPayload length: "+ encoded.length());	
				//[/DEBUG]
