    ...
    public void getInput(Circuit c, boolean is_alice, BufferedReader br) {
	   ...
	   // Verify it's an input object of the approriate player (i.e., Alice/Bob).
            ...
            try {
				...
				//i=0: bob_longitude; i=1:bob_latitude; i=2: alice_longitude; i=3:alice_latitude; 
				if (i==0) inpline = "22240";
				if (i==1) inpline = "114176";
				if (i==2) inpline = "22236";
				if (i==3) inpline = "114180";
