...
class Gate implements Serializable {
    ...
    public void generateEncGate() {
        ...
        //logger.debug("generateEncGate: encrypt gate with " + n_inputs + " inputs");
        ...
        for (i = 0; i < n_ent; i++) {
            ...
            //logger.debug("generateEncGate: i = " + i + " - encrypted_perm[" + permuted_index + "] = " + encrypted_perm[permuted_index]);
        }
